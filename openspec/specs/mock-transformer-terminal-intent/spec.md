...
Documents the invariant that the `_previous` transformer in `createTransformer` is intentionally never called, ensuring reviewers and contributors understand this load-bearing constraint for the transformer chain ordering.
