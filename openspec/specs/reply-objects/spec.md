...
1. The captured `chat_id` matches a chat this user is a participant of (private chat with this user, OR a group/supergroup/channel where this user has been minted as a member).
2. ANY of:
