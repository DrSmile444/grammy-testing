...
Provides the `BusinessAccount` actor for dispatching Telegram Business API updates in tests. Allows test authors to simulate business connections, messages, edits, and deletions without a real Telegram Business account.
