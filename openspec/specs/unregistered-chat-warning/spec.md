# unregistered-chat-warning Specification

## Purpose

Requirements for the developer warning emitted when a bot method targets a chat ID that has not been registered with the `Chats` orchestrator.
