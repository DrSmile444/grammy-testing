# modern-update-types Specification

## Purpose

Verbs on the `User` and chat actors that synthesize and dispatch Bot API 7+ update types —
reactions, poll answers, join requests, member changes, channel post edits, boosts, reaction
counts, and poll state.
