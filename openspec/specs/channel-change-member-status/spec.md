# channel-change-member-status Specification

## Purpose

Defines the `Channel.changeMemberStatus` dispatch verb and the `CHANNEL_ADMIN_RIGHTS` permission defaults for channel membership transitions.
